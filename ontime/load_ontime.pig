...
packed_data = FOREACH filtered_data GENERATE FlightDate, AirlineID, Origin, OriginCityName, OriginStateName, Dest, DestCityName, DestStateName, CRSDepTime,  DepDelay, CRSArrTime, ArrDelay, Cancelled, CancellationCode, Diverted, CRSElapsedTime, ActualElapsedTime, AirTime, Distance;
