...
CREATE TABLE best2path (flightdate TIMESTAMP, origin TEXT, destination TEXT, flightnum INT, crsdeptime TIMESTAMP, crsarrtime TIMESTAMP, arrdelay FLOAT, PRIMARY KEY(flightdate, origin, destination, arrdelay));
```
